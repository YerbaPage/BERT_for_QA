...
def main():
    ...
    print("albert_xxlarge-v2_2 train_epoch0 build model is finished!",flush=True)
    # training
    ...
    print("albert_xxlarge-v2_2 train_epoch0 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("albert_xxlarge-v2_2 train_epoch0 is finished!",flush=True)
