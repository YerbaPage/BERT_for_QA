...
def main():
    ...
    print("albert_xxlarge-v2_2 train_epoch1 build model is finished!",flush=True)
    ...
    print("albert_xxlarge-v2_2 train_epoch1 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("albert_xxlarge-v2_2 train_epoch1 is finished!",flush=True)
