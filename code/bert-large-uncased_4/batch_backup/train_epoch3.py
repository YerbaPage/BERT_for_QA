...
def main():
    ...
    print("bert-large-uncased_4 train_epoch3 pre input is finished!")
    ...
    print("bert-large-uncased_4 train_epoch3 build model is finished!",flush=True)
    ...
    print("bert-large-uncased_4 train_epoch3 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("bert-large-uncased_4 train_epoch3 is finished!",flush=True)
