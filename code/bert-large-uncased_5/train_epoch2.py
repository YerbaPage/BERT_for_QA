...
def main():
    ...
    print("bert-large-uncased_5 train_epoch2 pre input is finished!",flush=True)
    ...
    print("bert-large-uncased_5 train_epoch2 build model is finished!",flush=True)
    ...
    print("bert-large-uncased_5 train_epoch2 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("bert-large-uncased_5 train_epoch2 is finished!",flush=True)
