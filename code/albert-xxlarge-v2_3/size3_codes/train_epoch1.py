...
def main():
    ...
    print("albert_xxlarge-v2_3 train_epoch1 pre input is finished!",flush=True)
    ...
    print("albert_xxlarge-v2_3 train_epoch1 buld model is finished!",flush=True)
    ...
    print("albert_xxlarge-v2_3 train_epoch1 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("albert_xxlarge-v2_3 train_epoch1 is finished!",flush=True)
