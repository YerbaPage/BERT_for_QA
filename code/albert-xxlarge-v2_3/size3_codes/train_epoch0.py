...
def main():
    ...
    print("albert_xxlarge-v2_3 train_epoch0 buld model is finished!",flush=True)
    ...
    print("albert_xxlarge-v2_3 train_epoch0 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("albert_xxlarge-v2_3 train_epoch0 is finished!",flush=True)
