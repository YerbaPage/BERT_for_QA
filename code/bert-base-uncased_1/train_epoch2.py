...
def main():
    ...
    print("bert-base-uncased_1 train_epoch2 pre input is finished!")
    ...
    print("bert-base-uncased_1 train_epoch2 build model is finished!",flush=True)
    ...
    print("bert-base-uncased_1 train_epoch2 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("bert-base-uncased_1 train_epoch2 is finished!",flush=True)
