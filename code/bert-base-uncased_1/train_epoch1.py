...
def main():
    ...
    print("bert-base-uncased_1 train_epoch1 pre input is finished!",flush=True)
    ...
    print("bert-base-uncased_1 train_epoch1 build model is finished!",flush=True)
    ...
    print("bert-base-uncased_1 train_epoch1 train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("bert-base-uncased_1 train_epoch1 is finished!",flush=True)
