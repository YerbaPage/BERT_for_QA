...
def main():
    ...
    print("bert-base-uncased_1 train_epoch0_with_more_comments pre input is finished!",flush=True)
    ...
    print("bert-base-uncased_1 train_epoch0_with_more_comments build model is finished!",flush=True)
    ...
    print("bert-base-uncased_1 train_epoch0_with_more_comments train is finished!",flush=True)

if __name__ == "__main__":
    main()
    print("bert-base-uncased_1 train_epoch0_with_more_comments is finished!",flush=True)
